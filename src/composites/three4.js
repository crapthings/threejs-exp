  ...
  useEffect(() => {
    async function render () {
      ...
      new GLTFLoader().load('./soulless.glb', (gltf) => {
        ...
        gsap.fromTo(modelface.rotation, {
          y: -.5,
        }, {
          y: .5,
          repeat: -1,
      ...
      var geometry = new THREE.CapsuleGeometry(8, 4, 4, 8).toNonIndexed()
      ...
      function animation (time) {
        ...
        if (modelface) {
          // modelface.rotation.y += Math.cos(.001) * .001
          // modelface.materials[0].opacity -= 0.1
          // gsap.to(modelface.rotation, {
          //   y: 1,
          //   repeat: -1,
          //   yoyo: true,
          // })
